...
echo "==> Starting WAF Classic API emulator on :4566 (moto; same APIs as LocalStack Community waf-regional)"
python3 -m moto.server -p 4566 -H 127.0.0.1 >/tmp/xss-csrf-lab/waf-api.log 2>&1 &
...
echo "WAF Classic API: http://localhost:4566  (waf-regional)"
echo ""
